...
gameOver() {
  swal({
    ...
    imageUrl:
      "https://thumbor.forbes.com/thumbor/711x711/https://specials-images.forbesimg.com/imageserve/602c09c9135a060af5e1a8f4/Face-with-Spiral-Eyes---a-new-Apple-emoji-/960x0.png?fit=scale",
    imageSize: "100x100",
...
showRank() {
  swal({
    title: `AWESOME`,
    text: "YOU REACHED THE FINISH LINE AND YOUR RANK IS "+player.rank,
    imageUrl:
